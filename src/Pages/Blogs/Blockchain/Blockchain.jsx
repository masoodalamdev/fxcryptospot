import { Box, Grid, Toolbar, InputBase } from '@mui/material'
...
import { FcOrgUnit, FcCancel, } from 'react-icons/fc';
...
export default function Blockchain(props) {
  ...
  return (
    ...
    <PageHeader
        icon={searchBar ? (searchHeader.icon === true ? <SearchIcon size={24} /> : <FcCancel size={24} />) : <FcOrgUnit size={24} />}
        title={searchBar ? searchHeader.title : "Blockchain"}
